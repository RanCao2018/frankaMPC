...
void CompleteCartesianImpedanceExampleController::publishErrorState() {
  if (error_state_pub_.trylock()) {
    error_state_pub_.msg_.error_state[0] = position_[0];
    error_state_pub_.msg_.error_state[1] = position_[1];
    error_state_pub_.msg_.error_state[2] = position_[2];
    error_state_pub_.msg_.error_state[3] = velocity_[0];
    error_state_pub_.msg_.error_state[4] = velocity_[1];
    error_state_pub_.msg_.error_state[5] = velocity_[2];
    }
